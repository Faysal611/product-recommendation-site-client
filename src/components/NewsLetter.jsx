...
const NewsLetter = () => {
    return (
        <div className='flex flex-col items-center bg-gray-100 rounded-2xl'>
            ...
            <div className='mt-3'>
                <input className='bg-white outline outline-gray-300 w-[400px] h-[50px] placeholder:text-gray-400 rounded-tl-3xl rounded-bl-3xl pl-6 placeholder:text-xl' placeholder='user@email.com' type="text" />
